...
<body class="page-template-default page page-id-222 group-blog">
  ...
  <div id="main-content" class="container-main" role="document">
    ...
    <hr>
    <h1 style="text-align: center;font-family: Times New Roman, Times, serif;">-Liquidation Reports-</h1>
  <hr>
    <?php 
      $select = $conn->prepare("SELECT * FROM tblinformation WHERE SETTINGSNAME =? ORDER BY DATECREATED ASC");
      $select->execute(['liquidationreports']);
       ...
       ?>
        ...
        <div class="row">
            ...
            <div class="large-11 columns">
               <a href="liquidationreportsinfo?id=<?php echo $rows['ID'];?>"><h4><i class="fa fa-check"></i><?php echo $rows['TITLE'];?></h4> </a>
              <h5><i class="fa fa-calendar"></i> Date Posted: <?php echo $rows['DATECREATED'];?></h5>
              <!-- <div class="awards"><?php echo $rows['CONTENT'];?></div> -->
            </div>
        </div>
