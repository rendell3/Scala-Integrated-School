	...
	switch ($type) {
		...
		case 'history':
			...
			echo '<div class="alert alert-success alert-st-one" role="alert">
			                <p class="message-mg-rt"><strong>Successfully!</strong> Record has been saved.</p>
				</div>';
			break;
		...
		case 'schoolpersonnel':
            ...
            echo '<div class="alert alert-success alert-st-one" role="alert">
			                <p class="message-mg-rt"><strong>Sorry!</strong> '.$files.' is not Image files!</p>
				</div>';
       	 	}
			break;
...
echo '<div class="alert alert-success alert-st-one" role="alert">
                <p class="message-mg-rt"><strong>Sorry!</strong>'.$e.'.</p>
	</div>';
}
